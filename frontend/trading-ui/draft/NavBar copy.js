...
const Navbar = () => {
    return (
        <div className="flex flex-row h-full">
            <nav className="bg-white dark:bg-gray-800 w-18 h-screen justify-between flex flex-col">
                <div className="mt-10 mb-10 p-1">
                    
                    <a href="#" className="block relative">
                        <img alt="profil" src="https://www.theladders.com/s3proxy/company-photo.theladders.com/44781/43811f8d-0157-4ad5-baba-f5b03b434cc4.png" className="mx-auto object-cover rounded-full h-10 w-10 "/>
                    </a>
